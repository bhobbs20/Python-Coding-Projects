...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        self.btn_browse_1.grid(row=0, column=1, padx=(30, 0), pady=(120, 0), sticky=E)

        self.txt_browse_file_1 = tk.Entry(self.master, text='')
        self.txt_browse_file_1.grid(row=0, column=2, rowspan=1, columnspan=9, padx=(30, 40), pady=(120, 0), sticky=N + E + W)
        ...
        self.btn_check_files.grid(row=3, column=1, padx=(30, 0), pady=(40, 0), sticky=E)

        self.btn_cancel = tk.Button(self.master, width=12, height=1, text='Close Program', bg="lightgrey", highlightbackground='lightgrey')
        self.btn_cancel.grid(row=3, column=10, padx=(0, 30), pady=(40, 0))
